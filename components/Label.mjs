...
export default class Label extends _Component {
    ...
    _draw(
        ...
        if(this.text.includes("|PAGE_NO|", 0)) this.text = this.text.replace(/\|PAGE_NO\|/g, doc.pageNo);
        if(this.text.includes("|DATE_SHRT|", 0)) this.text = this.text.replace(/\|DATE_SHRT\|/g, new Date().toShortDate());
        if(this.text.includes("|DATE_FULL|", 0)) this.text = this.text.replace(/\|DATE_FULL\|/g, new Date());
